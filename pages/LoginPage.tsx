      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-emerald-600 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div><h1 className="text-3xl font-bold text-white">EducaSys</h1><p className="text-blue-100 text-sm">Sistema de Gestão de Avaliações</p></div>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-6">
          <div className="bg-white bg-opacity-10 backdrop-blur-sm p-6 rounded-2xl border border-white border-opacity-20">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Gestão Educacional Eficiente</h3>
            <p className="text-blue-50 text-sm">Gerencie provas e avaliações da sua rede de ensino de forma simples e segura.</p>
          </div>
        </div>

        <div className="relative z-10 text-blue-100 text-sm">© 2025 Seu Município. Todos os direitos reservados.</div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="lg:hidden flex items-center justify-center gap-3 mb-8">
            ...
            <div><h1 className="text-2xl font-bold text-gray-800">EducaSys</h1><p className="text-gray-500 text-sm">Sistema de Gestão de Avaliações</p></div>
          </div>
