        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-800">EducaSys</h1>
                <p className="text-xs text-gray-500">Sistema de Gestão de Avaliações Escolares</p>
              </div>
            </div>
      ...
      <footer className="relative z-20 bg-white border-t border-gray-100 py-4 mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-center text-sm text-gray-500">
            © 2025 Seu Município. Todos os direitos reservados.
          </p>
        </div>
      </footer>
    </div>
