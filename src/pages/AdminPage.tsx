...
const AdminPage: React.FC<AdminPageProps> = ({ onNavigate }) => {
    // Cole aqui todos os 'useState', 'useEffect', 'useMemo', 'useCallback'
    // e as funções de manipulação de evento (handlers) que estavam no componente AdminPage original.
    ...
    // ... (restante dos useEffects e handlers) ...
  ...
  return (
    // Cole aqui o JSX do componente AdminPage original.
